...
final quests = <String, Quest>{
  ...
  'main_26': const Quest(
    id: 'main_26',
    name: '镇派之宝',
    description: '掌门告诉你，古玉是开启天剑门藏剑阁的钥匙之一。但另一把钥匙在百年前的门派之争中遗失了。',
    type: QuestType.main,
    objectives: [
      QuestObjective(
        id: 'main_26_1',
    ...
    rewardSilver: 320,
    rewardReputation: 30,
    prerequisiteQuestId: 'main_25',
  ),
  'main_27': const Quest(
    id: 'main_27',
    name: '寻找线索',
    description: '掌门建议你去找白无常，他博闻强识，或许知道另一把钥匙的下落。',
    type: QuestType.main,
    objectives: [
      QuestObjective(
        id: 'main_27_1',
  ...
  'main_28': const Quest(
    id: 'main_28',
    name: '古籍记载',
    description: '白无常翻阅古籍后告诉你，另一把钥匙可能藏在迷雾谷深处的古墓中。但那里危机四伏，需要做好准备。',
    type: QuestType.main,
    objectives: [
      QuestObjective(
        id: 'main_28_1',
      ...
      QuestObjective(
        ...
        description: '收集回气丹',
        type: QuestObjectiveType.collect,
        targetId: 'spirit_pill',
        requiredCount: 3,
      ),
    ],
    rewardExp: 400,
    rewardSilver: 360,
    prerequisiteQuestId: 'main_27',
  ),
  'main_29': const Quest(
    id: 'main_29',
    name: '深入古墓',
    description: '准备充足后，前往迷雾谷深处寻找古墓入口。',
    type: QuestType.main,
    objectives: [
      QuestObjective(
        id: 'main_29_1',
    ...
    rewardSilver: 400,
    rewardReputation: 40,
    prerequisiteQuestId: 'main_28',
  ),
  'main_30': const Quest(
    id: 'main_30',
    name: '第二把钥匙',
    description: '在古墓深处，你找到了另一把古玉钥匙。但墓中壁画显示，这只是开始——藏剑阁中封印着一个惊天秘密。',
    type: QuestType.main,
    objectives: [
      QuestObjective(
        id: 'main_30_1',
    ...
    rewardSilver: 450,
    rewardReputation: 50,
    rewardItemId: 'ancient_jade_key',
    prerequisiteQuestId: 'main_29',
  ),
  ...
  'side_21': const Quest(
    id: 'side_21',
    name: '秦铸的刀谱',
    description: '秦铸整理旧刀谱时发现一套失传的刀风心法，但需要用实战验证。帮他击败山贼头子作为刀谱校对的参照。',
    type: QuestType.side,
    objectives: [
      QuestObjective(
        id: 'side_21_1',
    ...
    rewardExp: 80,
    rewardSilver: 60,
    rewardSkillId: 'passive_blade_wind',
    prerequisiteQuestId: 'main_06',
    questGiverNpcId: 'qin_zhu',
    questLocationId: 'luoxia_mountains',
  ),
  'side_22': const Quest(
    id: 'side_22',
    name: '酒馆的教训',
    description: '柳如烟说最近有个打把式卖艺的老头在醉仙楼传授街斗技巧。先替她收拾几个醉汉练练手，回来她帮你引荐。',
    type: QuestType.side,
    objectives: [
      QuestObjective(
        id: 'side_22_1',
    ...
    rewardExp: 60,
    rewardSilver: 45,
    rewardSkillId: 'passive_counter_punch',
    prerequisiteQuestId: 'main_03',
    questGiverNpcId: 'liu_ruyan',
    questLocationId: 'qingfeng_town',
  ),
  'side_23': const Quest(
    id: 'side_23',
    name: '月影残卷',
    description: '苏晚吟在望月楼古籍中发现了一卷残缺的步法秘籍。她需要你在望月楼多次探索收集散落的残页，拼凑完整后即可传授。',
    type: QuestType.side,
    objectives: [
      QuestObjective(
        id: 'side_23_1',
    ...
    rewardExp: 90,
    rewardSilver: 70,
    rewardSkillId: 'passive_shadow_step',
    prerequisiteQuestId: 'main_04',
    questGiverNpcId: 'su_wanyin',
    questLocationId: 'wangyue_tower',
  ),
  'side_24': const Quest(
    id: 'side_24',
    name: '雾谷真气试炼',
    description: '林风认为迷雾谷的浓雾能催发体内潜力。他建议你深入谷中击败怨灵，借战斗中的生死压力突破真气极限。',
    type: QuestType.side,
    objectives: [
      QuestObjective(
        id: 'side_24_1',
    ...
    rewardExp: 130,
    rewardSilver: 100,
    rewardSkillId: 'passive_qi_burst',
    prerequisiteQuestId: 'main_10',
    questGiverNpcId: 'lin_feng',
    questLocationId: 'miwu_valley',
  ),
